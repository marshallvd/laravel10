            ...
            <ul class="list-inline mb-0">
                <li class="list-inline-item px-2">
                    <a href="https://www.linkedin.com/in/marshallvd/" target="_blank">
                        <img class="avatar rounded-circle" alt="LinkedIn" src="{{ asset('storage/volt/html&css/assets/img/icons/linkedin.png') }}">
                    </a>
                </li>
                <li class="list-inline-item px-2">
                    <a href="https://www.instagram.com/marshallvd/?hl=en" target="_blank">
                        <img class="avatar rounded-circle" alt="Instagram" src="{{ asset('storage/volt/html&css/assets/img/icons/instagram.png') }}">
                    </a>
                </li>
            </ul>
        </div>
