...
<!-- Favicon -->
<link rel="apple-touch-icon" sizes="120x120" href="{{ asset('volt/src/assets/img/favicon/brand/hmti.png') }}">
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('volt/src/assets/img/brand/hmti.png') }}">
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('volt/src/assets/img/brand/hmti.png') }}">
<link rel="manifest" href="{{ asset('volt/src/assets/img/brand/hmti.png') }}">
<link rel="mask-icon" href="{{ asset('volt/src/assets/img/brand/hmti.png') }}" color="#ffffff">
