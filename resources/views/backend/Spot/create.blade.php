...
@section('content')
    <div class="container">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <!-- Judul Tugas -->
                        <h2 class="text-black">Tambahkan Lokasi</h2>
                    <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <label for=""><h3>Tambah Data Lokasi</h3></label>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group my-3">
                        ...
                        @enderror" name="nama_rs" id="namna_rs">
                        @error('nama_rs')
                            <div class="invalid-feedback">{{ $message }}</div>                        
                        @enderror
                    </div>
                    ...
                    <div class="form-group my-3">
                        ...
                        <textarea type="text" class="form-control @error('deskripsi') @enderror" name="deskripsi" id="deskripsi"></textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control @error('tipe') @enderror" name="tipe" id="tipe">
                        @error('tipe')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
